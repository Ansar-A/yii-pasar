...
// more-details end
$("body").append(
  '<div class="fixed-button active"><a href="https://uin-alauddin.ac.id/" target="_blank" class="btn btn-md btn-primary"><i class="feather icon-info" aria-hidden="true"></i> Develop by UINAM</a> </div>'
);
